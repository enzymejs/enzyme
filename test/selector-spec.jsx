  ...
  tests.forEach(({ describeMethod, name, renderMethod }) => {
    describeMethod(name, () => {
      it('simple descendent', () => {
        ...
        expect(wrapper.find('.top-div span').text()).to.equal('inside top div');
      });
      ...
      it('deep descendent', () => {
        ...
        expect(wrapper.find('div .inner span .way-inner h1').text()).to.equal('heading');
      });
